  ...
  return (
    <div className="bg-gray-100 min-h-screen">
      ...
      <main className="max-w-7xl mx-auto py-6 sm:px-6 lg:px-8">
        ...
        {/* Header Card */}
        <div className="bg-white shadow-lg rounded-xl overflow-hidden mb-6 border-l-4 border-sky-600">
          <div className="p-6">
            <div className="flex items-center justify-between mb-4">
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Número: {assembly.numero}</p>
              ...
              <div className="text-right">
                <div className="mb-3">
                  ...
                  <p className="text-4xl font-bold text-sky-600">{progress}%</p>
                </div>
            ...
            <div className="mt-4 pt-4 border-t border-gray-200">
              <div className="flex items-center justify-between">
                <div>
                  <p className="text-sm text-gray-500">Fecha de Deadline</p>
                  <p className="text-lg font-semibold text-gray-900">{assembly.fechaDeadline}</p>
                </div>
                <div className="text-right">
          ...
          <div className="p-6 bg-gray-50">
            {history.length === 0 ? (
              <div className="text-center py-12 bg-white rounded-lg border-2 border-dashed border-gray-300">
                ...
                <p className="text-gray-400 text-sm mt-2">El ingeniero aún no ha registrado información</p>
              </div>
            ) : (
                ...
                {history.map((record, index) => (
                  ...
                  >
                    ...
                    <div className={`px-5 py-4 flex items-center justify-between ${
                      ...
                      <div className={`px-3 py-1 rounded-lg font-semibold text-xs ${
