      ...
      <main className="max-w-7xl mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-3 sm:gap-5 mb-4 sm:mb-6">
          ...
          <div className="bg-white shadow-lg rounded-lg p-4 sm:p-5">
            <h4 className="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Ensambles Activos</h4>
            <p className="text-2xl sm:text-3xl font-semibold text-sky-700">{stats.activeAssemblies}</p>
            <p className="text-xs sm:text-sm text-gray-400 mt-1">Total en proceso</p>
          </div>
          
          {/* KPI 2: Terminados (Últimos 7 días) */}
          <div className="bg-white shadow-lg rounded-lg p-4 sm:p-5">
            <h4 className="text-xs sm:text-sm font-medium text-gray-500 uppercase tracking-wider">Terminados (Últ. 7 días)</h4>
            <p className="text-2xl sm:text-3xl font-semibold text-green-600">{stats.completedLast7Days}</p>
            <p className="text-xs sm:text-sm text-gray-400 mt-1">Completados esta semana</p>
          </div>
              ...
              <div key={engineer.id} className="bg-white shadow-lg rounded-xl overflow-hidden border border-gray-200">
                ...
                <div className="grid grid-cols-2 gap-3 sm:gap-4 p-4 sm:p-5 bg-gray-50 border-b border-gray-200">
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm border border-gray-200">
                    <div className="flex items-center space-x-2 mb-2">
                      <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="w-4 h-4 sm:w-5 sm:h-5 text-green-600">
                        <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                      </svg>
                      <span className="text-xs font-medium text-gray-500 uppercase">Activos</span>
                    </div>
                    <p className="text-xl sm:text-2xl font-bold text-green-600">{engineer.activeAssemblies.length}</p>
                  </div>
                  ...
                  <div className="bg-white rounded-lg p-3 sm:p-4 shadow-sm border border-gray-200">
                    ...
                    <p className="text-xl sm:text-2xl font-bold text-blue-600">{engineer.completedAssemblies.length}</p>
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 gap-3 sm:gap-4 p-4 sm:p-5 bg-white border-b border-gray-200">
                  ...
                  <div className="flex items-center space-x-2 p-3 bg-blue-50 rounded-lg border border-blue-200">
                    ...
                    <div>
                      ...
                      <p className="text-lg sm:text-xl font-bold text-blue-900">{engineer.stats.qcCount}</p>
                    </div>
                  </div>
                  ...
                  <div className="flex items-center space-x-2 p-3 bg-green-50 rounded-lg border border-green-200">
                    ...
                    <div>
                      ...
                      <p className="text-lg sm:text-xl font-bold text-green-900">{engineer.stats.teachCount}</p>
                    </div>
                  </div>
                ...
                <div className="overflow-x-auto">
                  <div className="bg-gray-50 px-4 sm:px-5 py-3 border-b border-gray-200">
                    <h4 className="text-xs sm:text-sm font-bold text-gray-700 uppercase tracking-wide">
                          ...
                          <>
                            ...
                            <td className="px-3 sm:px-5 py-3 sm:py-4 whitespace-nowrap">
                              <div className="flex items-center space-x-2">
                                <div className="text-xs sm:text-sm font-semibold text-gray-900">{assembly.maquina} / {assembly.modelo}</div>
                              </div>
                            ...
                            <td className="px-3 sm:px-5 py-3 sm:py-4 whitespace-nowrap">
                              <div className="flex items-center space-x-2">
                                <div className="flex-1 w-16 sm:w-20 bg-gray-200 rounded-full h-2 shadow-inner">
                                  <div 
                                ...
                                <span className="text-xs sm:text-sm font-bold text-gray-900">{assembly.progress || 0}%</span>
                              </div>
                            </td>
                            <td className="px-3 sm:px-5 py-3 sm:py-4 whitespace-nowrap">
                              {(() => {
                            ...
                            {/* <td className="px-3 sm:px-5 py-3 sm:py-4 whitespace-nowrap">
                              {isOverdue ? (
                                ...
                                <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs font-bold bg-yellow-100 text-yellow-800 border-2 border-yellow-300">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3 h-3 sm:w-4 sm:h-4 mr-1">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M12 9v3.75m-9.303 3.376c-.866 1.5.217 3.374 1.948 3.374h14.71c1.73 0 2.813-1.874 1.948-3.374L13.949 3.378c-.866-1.5-3.032-1.5-3.898 0L2.697 16.126zM12 15.75h.007v.008H12v-.008z" />
                                  </svg>
                                  En Riesgo
                                ...
                                <span className="inline-flex items-center px-2 sm:px-3 py-1 rounded-full text-xs font-bold bg-green-100 text-green-800 border-2 border-green-300">
                                  <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className="w-3 h-3 sm:w-4 sm:h-4 mr-1">
                                    <path strokeLinecap="round" strokeLinejoin="round" d="M9 12.75L11.25 15 15 9.75M21 12a9 9 0 11-18 0 9 9 0 0118 0z" />
                                  </svg>
                                  Activo
                              ...
                              <div className="flex flex-col sm:flex-row items-stretch sm:items-center space-y-2 sm:space-y-0 sm:space-x-2">
                                {hasStats ? (
                                  <button
                                    ...
                                    className="inline-flex items-center justify-center px-2 sm:px-3 py-1.5 sm:py-2 bg-sky-100 hover:bg-sky-200 text-sky-700 rounded-lg font-semibold text-xs transition-all shadow-sm border border-sky-300"
                                  >
                                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor" className={`w-3 h-3 sm:w-4 sm:h-4 mr-1 transition-transform ${isExpanded ? 'rotate-180' : ''}`}>
                                      <path strokeLinecap="round" strokeLinejoin="round" d="M19.5 8.25l-7.5 7.5-7.5-7.5" />
                                    </svg>
                                    <span className="hidden sm:inline">{isExpanded ? 'Ocultar' : 'Ver Stats'}</span>
                                    <span className="sm:hidden">{isExpanded ? 'Ocultar' : 'Stats'}</span>
                                  </button>
                                ) : (
