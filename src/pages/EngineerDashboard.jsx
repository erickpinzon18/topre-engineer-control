      ...
      <main className="container mx-auto py-4 sm:py-6 px-4 sm:px-6 lg:px-8">
        ...
        <div className="space-y-6 lg:grid lg:grid-cols-12 lg:gap-6 lg:space-y-0">
          ...
          <div className="lg:col-span-3 space-y-4">
            ...
            {/* Botón Checklist Diario */}
            <button
              onClick={() => navigate('/engineer/assy/checklist')}
              className="w-full flex items-center justify-center gap-2 bg-purple-600 hover:bg-purple-700 text-white font-bold py-3 px-4 rounded-lg shadow-md transition duration-300"
            >
