    ...
    <div className="min-h-screen bg-gray-100">
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex justify-between items-center py-4">
            <div className="flex items-center space-x-3">
              ...
              <div>
                <h1 className="text-xl font-bold text-gray-900">Panel de Press</h1>
                <p className="text-sm text-gray-500">Control de Ingeniería - Prensado</p>
              </div>
            </div>
      ...
      <main className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        <div className="bg-white rounded-xl shadow-sm border border-gray-200 p-12 text-center">
          ...
          <h2 className="text-2xl font-bold text-gray-900 mb-3">Sección de Prensado (Press)</h2>
          <p className="text-gray-500 text-lg mb-6">
            Esta sección está en desarrollo. Próximamente podrás gestionar los procesos de prensado.
          </p>
